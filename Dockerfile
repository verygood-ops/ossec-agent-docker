# Let's use Ubuntu Phusion vs Alpine because Wazuh-OSSEC is
# Designed and tested primarility for Wazuh-ossec
FROM phusion/baseimage:0.9.15

LABEL "com.vgs.security.utils.aws-cli"="Very Good Security"
LABEL "MAINTAINER"="security <security@vgs.io>"

# Following the server installation parameters specified on the OSSEC website
